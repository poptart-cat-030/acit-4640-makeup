...
# get the most recent ami for Debian 13 - CHANGED FROM UBUNTU
# https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ami
data "aws_ami" "debian" {
  most_recent = true
  owners      = ["amazon"]  # Keep as amazon like the original
...
# debian front end - CHANGED FROM UBUNTU
module "frontend" {
  source                 = "./modules/web-server/"
  project_name           = local.project_name
...
output "redis" {
  description = "output for redis ec2"
