...
1. Run the following command in the folder you want to store the key pair in:
```
...
1. Navigate to the `ansible` folder of the project directory (ex: `<insert_some_path_here>/acit-4640-lab_wk11/ansible`)
